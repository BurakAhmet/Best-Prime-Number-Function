...
def main() -> int:
    ...
    # CLI default is the 73-bit hard-path yardstick (not evaluated here).
    if DEFAULT_N != 7_000_000_000_000_000_000_037:
        print(f"  FAIL  DEFAULT_N drifted: {DEFAULT_N}")
        return 1
    print("  OK  DEFAULT_N is the 73-bit hard-path yardstick")
