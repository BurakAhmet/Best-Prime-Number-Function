...
| 1000000000000000000000000000000000000003 | CLI default (130-bit cubic) | ~0.3 s |
...
OMP_NUM_THREADS=$(nproc) python -m best_prime --lab 1000000000000000000000000000000000000003
