...
> **Warning:** This repository (including this wiki content) was largely **created and designed by an AI agent**. Review before production use.

## Pages

| Page | Description |
|------|-------------|
| [Home](Home) | This index |
| [Project restrictions](Project-restrictions) | Non-negotiable design rules for humans and agents |
| [Algorithm overview](Algorithm-overview) | Wheel trial division and AKS paths |
| [CI and automation](CI-and-automation) | GitHub Actions: tests, determinism, performance, issue/PR agents |
| [Agent briefing](Agent-briefing) | What automated agents must follow |
