...
| Area | Symbols |
|------|---------|
| Primality | `is_prime` (also list/array), `lab`, `primality_certificate`, `verify_certificate`, `UnsettledPrimalityError` |
...
| Factors / powers | `prime_factors` / `factorint` (`max_ms` cap), `UnsettledFactorError`, `lehman_factor`, `is_perfect_power`, `is_prime_power` |
