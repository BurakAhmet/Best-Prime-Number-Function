...
**Repo:** deterministic `is_prime` / `next_prime` (OpenMP C precomputed-prime + segmented sieve; stdlib/Numba wheels as fallback; full trial for practical multi-limb sizes; AKS only for huge ints).  
